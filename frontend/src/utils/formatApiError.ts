...
const DETAIL_RU: Record<string, string> = {
    ...
    attachment_limit_reached: 'К заявке можно прикрепить не более 10 файлов',
    attachment_too_large: 'Файл слишком большой (максимум 1 ГБ)',
    attachment_type_not_allowed: 'Допустимы только фото и видео',
